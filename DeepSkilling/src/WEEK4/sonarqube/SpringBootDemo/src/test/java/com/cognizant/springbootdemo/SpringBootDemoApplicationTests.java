...
class SpringBootDemoApplicationTests {
    ...
    @Test
    void createsDefaultCarPurchaseProfileForRajkaran() {
        CarPurchaseProfile profile = carPurchaseService.createDefaultProfile();

        assertThat(profile.buyerName()).isEqualTo("Rajkaran ");
    ...
    void createsPurchaseSummaryWithTrimmedBuyerName() {
        CarPurchaseProfile profile = new CarPurchaseProfile(" Rajkaran ", "Hyundai Creta SX", 1800000, 780);

        String summary = carPurchaseService.createPurchaseSummary(profile);

        assertThat(summary).isEqualTo("Rajkaran wants to purchase Hyundai Creta SX");
    }
    ...
    void marksBuyerEligibleForPremiumCar() {
        CarPurchaseProfile profile = new CarPurchaseProfile("Rajkaran ", "Honda City ZX", 1600000, 780);
    ...
    void recommendsLoanWhenBudgetIsLowerButCreditScoreIsGood() {
        CarPurchaseProfile profile = new CarPurchaseProfile("Rajkaran ", "Honda City ZX", 1200000, 730);
