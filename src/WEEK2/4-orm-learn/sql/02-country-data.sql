-- ===========================================================================
-- country-data.sql  (Doc 1 / Hands-on 5: populate country table)
-- Full ISO country list extracted from the assignment document.
-- Run AFTER schema.sql.  Names with apostrophes are SQL-escaped ('').
-- ===========================================================================
